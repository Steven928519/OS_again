...
int main(void)
{
  ...
  __HAL_TIM_SET_COMPARE(&htim8, TIM_CHANNEL_1, 350);
  ...
  __HAL_TIM_SET_COMPARE(&htim8, TIM_CHANNEL_2, 350);
  ...
  __HAL_TIM_SET_COMPARE(&htim8, TIM_CHANNEL_3, 350);
  ...
  __HAL_TIM_SET_COMPARE(&htim8, TIM_CHANNEL_4, 350);
